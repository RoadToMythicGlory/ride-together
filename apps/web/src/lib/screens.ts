...
export const SCREENS: ScreenDef[] = [
  ...
  { href: '/rider/events/view?id=example-id', title: 'פרטי מפגש חי', blurb: 'פירוט מפגש ואישור השתתפות.', group: 'rider' },
  ...
  { href: '/parent/applications/view?id=example-id', title: 'פרטי בקשה', blurb: 'סטטוס ופרטי בקשה שהוגשה.', group: 'parent' },
  ...
  { href: '/manager/applications/view?id=example-id', title: 'סקירת בקשה חיה', blurb: 'החלטה ושיבוץ לבקשה.', group: 'manager' },
